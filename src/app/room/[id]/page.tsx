...
export default function RoomPage() {
  ...
  return (
    <div className='min-h-screen max-w-6xl mx-auto p-6 grid md:grid-cols-3 gap-8'>
      {/* Filter Sidebar */}
      <div className='border p-4 col-span-1'>
        <div className='bg-gray-100 p-4 space-y-4'>
          <div>
            <p className='font-semibold text-sm mb-1'>CHECK IN AVAILABILITY</p>
          ...
          <div>
            <label className='block text-sm text-gray-600'>Check-in time</label>
            <input
              type='text'
              className='w-full p-2 mt-1 bg-pink-100 rounded'
              value={checkInTime}
